...
def test_set_voting_period(web3, voting_contract):
    try:
        assert voting_contract is not None, "Voting contract is not initialized"
        tx = voting_contract.function.setVotingPeriod(5).transact({'from':web3.eth.default_account})
